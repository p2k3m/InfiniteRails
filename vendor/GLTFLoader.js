var GLTFLoaderModule = (() => {
  ...
  var __require = (id) => {
    if (id === "three") {
      const scope = typeof window !== 'undefined' ? window : typeof globalThis !== 'undefined' ? globalThis : global;
      const three = scope.THREE_GLOBAL || scope.THREE;
      if (!three) {
        throw new Error('Three.js is required before loading GLTFLoader.');
      }
      return three;
    }
    throw new Error('Dynamic require of "' + id + '" is not supported in this build.');
  };
